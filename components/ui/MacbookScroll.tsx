...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[160vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-80"
    >
      <motion.h2
        style={{
      ...
      >
        {title || <span>Enjoy the scroll once more.</span>}
      </motion.h2>
      {/* Lid */}
      <Lid
        src={src}
