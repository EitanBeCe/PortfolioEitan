...
import { myProjects, projects } from "@/data";
  ...
  return (
    <section id="projects" className="py-20">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10">
        {myProjects.map(({ title, des, iconLists, img, link }, index) => (
          <div
                ...
                <img
                  ...
                  className={`z-10 absolute ${
                    title.includes("iPhone")
                      ? "bottom-0"
                      : title.includes("Brainwave")
                      ? "-bottom-24 max-sm:h-[100%] h-[90%] rounded-t-xl rotate-3"
                      : "-bottom-32 max-sm:h-[120%] h-[100%] rounded-t-xl rotate-3"
                  }`}
                />
              </div>
